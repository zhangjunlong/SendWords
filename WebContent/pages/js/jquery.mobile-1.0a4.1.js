		...
		var $dataEls = $elem.find( ":jqmData(role)" ).andSelf().each(function() {
			...
			if ( role === "header" || role === "footer" ) {
				...
				if ( o.addBackBtn && role === "header" &&
					...
					var backBtn = $( "<a href='#' id='backBtn' class='ui-btn-left' data-"+ $.mobile.ns +"rel='back' data-"+ $.mobile.ns +"icon='arrow-l'>"+ o.backBtnText +"</a>" ).prependTo( $this );
...
$.widget( "mobile.listview", $.mobile.widget, {
	...
	_itemApply: function( $list, item ) {
		...
		$list.find( "li" ).find( "img:first, >img:eq(0), >:first>img:eq(0)" ).addClass( "ui-li-thumb" ).each(function() {
	...
	refresh: function( create ) {
		...
		li.each(function( pos ) {
			...
			if( o.inset ){	
				if ( pos === 0 ) {
						itemClass += " ui-corner-top  ui-li-has-thumb";
